...
struct AuthServiceView: View {
    @EnvironmentObject var container: DIContainer
    @StateObject var viewModel: AuthServiceViewModel
...
fileprivate struct ServiceListView: View {
    private let viewModel: AuthServiceViewModel
...
fileprivate struct ServiceCellView: View {
    private let apiTitle: String
        ...
        @ObservedObject private var viewModel: AuthServiceViewModel
