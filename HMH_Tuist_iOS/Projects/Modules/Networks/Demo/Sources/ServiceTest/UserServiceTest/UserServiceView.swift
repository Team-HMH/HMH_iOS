...
fileprivate struct ServiceListView: View {
    private let viewModel: UserServiceViewModel
    
    init(viewModel: UserServiceViewModel) {
...
fileprivate struct ServiceCellView: View {
    private let apiTitle: String
        ...
        @ObservedObject private var viewModel: UserServiceViewModel
        
        init(apiTitle: String, index: Int, viewModel: UserServiceViewModel) {
